...
from DCSRNyunzeman.FFT import LRbyFFT
...
class MedicalImageDataProvider(BaseDataProvider):
    ...
    def __init__(self, search_path = r'C:\Users\Estudiante\Documents\datasetMRI\Aug/*.npy', a_min=None, a_max=None, shuffle_data=True):
