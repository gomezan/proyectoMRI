...
#     prediction = model(test_input, training=True).numpy()
    ...
    # plt.show()
    plt.savefig(r"C:\Users\Estudiante\PycharmProjects\pruebaModelos\DCSRNomagdy\DCSRNmain\generated_plots/"+figure_name+'.png', bbox_inches='tight')
...
def plot_losses(epochs_plot, total_generator_g_error_plot):
    ...
    plt.legend()
    # plt.show()
    plt.savefig(r"C:\Users\Estudiante\PycharmProjects\pruebaModelos\DCSRNomagdy\DCSRNmain\generated_plots/losses_plot.png", bbox_inches='tight')
