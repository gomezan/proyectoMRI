...
from DCSRNomagdy.DCSRNmain.logger import log
from DCSRNomagdy.DCSRNmain.loss_functions import supervised_loss
from DCSRNomagdy.DCSRNmain.plotting import generate_images, plot_losses
from DCSRNomagdy.DCSRNmain.data_preparing import get_batch_data
from DCSRNomagdy.DCSRNmain.model_checkpoints import get_generator, save_generator
...
def training_loop(LR_G, EPOCHS, BATCH_SIZE, N_TRAINING_DATA, LOSS_FUNC, EPOCH_START):
    begin_log = '### Began training at {} with parameters: Starting Epoch={}, Epochs={}, Batch Size={}, Training Data={}, Learning Rate={}, Loss Function={}'.format(
        time.ctime(), EPOCH_START, EPOCHS, BATCH_SIZE, N_TRAINING_DATA, LR_G, LOSS_FUNC)
    log(begin_log)
